...
> 阅读 [免费额度秒变 40 万债务？学生误泄 Gemini API 密钥背上巨额账单](https://news.qq.com/rain/a/20250928A049ZA00) 思考 cookie 泄露的后果。
...
众所不周知，西二在线拥有福州大学转专业群的名义管辖权，但也只是名义。

不过既然挂了这个名，总得做点实事，毕竟飞跃手册就是西二在线创办的。

对想转专业的学弟学妹来说，了解一个专业最差的方式之一，就是阅读培养方案；但反过来说，培养方案又是最直接、最成体系的参考资料。

于是就有了这个看似简单其实很难的任务：爬取福州大学近二十年所有专业年份的培养方案。

这份作业技术上并不难，难的是思路。

> 提示：去各个学院爬他们的官网这条路是走不通的，可以尝试从福大高考高招获取历年专业代号。拿到代号之后，后续可以自己思考。
