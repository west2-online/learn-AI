...
各位在通过所有考核后方可成为西二在线网络工作室的正式成员，均会发放实习证明和成员证书，可使用工作室内的资源组队参与相关的算法比赛，~~或者来玩无人机~~，同时还有外包、实习、固定工位、活动室、大量科研机会等福利。

西二的考核的本质普及性的推广，是指一条路去学习，而非选拔性的考核，因此请尽可能地完善考核内容，而非仅仅停留在考核本身的规定。

考核内容会不断更新，尤其是第7轮的设置，请各位注意关注。

此外，考核只会在前几轮筛选掉浑水摸鱼的人，此后只需要坚持下来即可。
