...
当然，对于其他的机器学习算法（也就是和深度学习相对关系没那么强的），只需要了解然后掌握一些基本的原理，会使用[sk-learn](https://scikit-learn.org/stable/)，不需要从零开始手敲，我们的目的在于更前沿的深度学习。
...
* **sk-learn**: [sk-learn官网](https://scikit-learn.org/stable/user_guide.html)（官方手册够用了）
